...
/**
 * For Variable length quantity values, value holds the actual value expressed by MIDI the message
 * @throws RangeError if 4 bytes have been read without being able to return the value
 */
